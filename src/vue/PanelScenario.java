...
public class PanelScenario extends JPanel {
	...
	public void afficherBoutonScenario() {
		...
		String[] images = {"images/scenarios/infrantries-lourdes.jpg", "images/scenarios/match-de-4-mins.jpg", "images/scenarios/jeu-standard.jpg", "images/scenarios/tuez-5-soldats-et-gagnez.jpg", "images/scenarios/gardez-un-soldat.jpg"};
		for(i=0; i<5; i++) {
			boutonImage = new JButton("");
			boutonImage.setIcon(new ImageIcon(images[i]));
			boutonImage.setBorder(null);
			boutonImage.setOpaque(false);
			panelPrincipal.add(boutonImage);
			
			System.out.println(boutonImage.getBounds());
		}
	}
